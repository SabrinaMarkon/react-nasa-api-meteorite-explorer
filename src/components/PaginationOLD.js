...
export default class Pagination extends Component {
  ...
  fetchPageNumbers = () => {
      ...
      console.log(this.totalRecords + '-' + totalPages + '-' + currentPage + '-' + pageNeighbors);
      /* 2 for each side, left and right of the current page. */
      const totalNumbersToShow = (pageNeighbors * 2) + 3;
      /* totalBlocksToShow = totalNumbersToShow + 2 for the < and > buttons. */
      ...
      // we hide some of the page number buttons at both ends.
       ...
       spillOffset: number of hidden pages either to the left or to the right. */
          ...
          const hasLeftSpill = false;
          const hasRightSpill = false;
